...
namespace UdeyTech\GmailSmtpApp\Block\Adminhtml;
...
use UdeyTech\GmailSmtpApp\Model\Email;
use Zend_Mail;
...
class ValidateConfig extends Template
{
    ...
    protected function validateServerEmailSetting()
    {
        ...
        //Create email
        $name = 'Test from UdeyTech SMTP';
        $mail = new Zend_Mail();
        $mail->setFrom($this->fromAddress, $name);
        $mail->addTo($this->toAddress, $this->toAddress);
        $mail->setSubject('Hello from UdeyTech SMTP (1 of 2)');
    ...
    protected function validateMagentoEmailSetting()
    {
        ...
        try {
            $this->_email
                ...
                ->send(
                    ['email' => $this->fromAddress, 'name' => 'Test from UdeyTech SMTP'],
