...
namespace UdeyTech\LoginAsCustomer\Controller\Login;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        try {
            ...
            // Check if the login key is valid from the table named udeytech_login_as_customer
            ...
            $this->_redirect('udeytech_loginascustomer/login/success');
            return true;
        } catch (\Exception $e) {
